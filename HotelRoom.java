public class HotelRoom {
    ...
    public HotelRoom(int roomNum, int numBeds) {
        if (roomNumOk(roomNum)) _roomNum = roomNum;
        else _roomNum = DEFAULT_ROOMNUM;

        if (numBedsOk(numBeds)) _numBeds = numBeds;
        else _numBeds = DEFAULT_NUMBEDS;
    ...
    public String toString() {
        if (_occupied) return "Room " + _roomNum + ", " + _numBeds + " Beds: Occupied by " + _guest;
        else return "Room " + _roomNum + ", " + _numBeds + " Beds: Available";
    }
